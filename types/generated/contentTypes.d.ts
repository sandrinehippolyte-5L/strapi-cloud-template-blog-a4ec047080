...
export interface ApiSheepitlabExperimentSheepitlabExperiment
  extends Struct.CollectionTypeSchema {
  collectionName: 'sheepitlab_experiments';
  info: {
    displayName: 'Sheepitlab experiments';
    pluralName: 'sheepitlab-experiments';
    singularName: 'sheepitlab-experiment';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    experiment_frame: Schema.Attribute.Component<
      'shared.experiment-frame',
      false
    >;
    ...
    > &
      Schema.Attribute.Private;
    main_visual: Schema.Attribute.Media<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what_doesnt: Schema.Attribute.Text;
    what_users_did: Schema.Attribute.Text;
    what_works: Schema.Attribute.Text;
    why_this_question: Schema.Attribute.Text;
  };
}
...
export interface ApiUseCaseUseCase extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    client_context: Schema.Attribute.Text;
    ...
    key_takeaways: Schema.Attribute.Component<'shared.takeaway', true> &
      ...
      >;
    keywords_custom: Schema.Attribute.String;
    limits_and_watchouts: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::use-case.use-case'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usecase_type: Schema.Attribute.Enumeration<
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sheepitlab-experiment.sheepitlab-experiment': ApiSheepitlabExperimentSheepitlabExperiment;
